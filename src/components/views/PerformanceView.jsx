        ...
        <div className="space-y-10">
            <div className="classic-frame rounded-[3rem] shadow-vision border border-white/60 p-10">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-10">
                    ...
                    <button onClick={() => setCommissionModalOpen(true)} className="btn-gold flex items-center gap-2 px-6 py-3 font-bold rounded-2xl text-sm uppercase tracking-wide" style={{ border: 'none' }}>
