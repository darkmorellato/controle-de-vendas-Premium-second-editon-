                    ...
                    return (
                        <div className="space-y-8">
                            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest flex items-center gap-2">
                                ...
                                Ranking — {now.toLocaleString('pt-BR',{month:'long',year:'numeric'})}
                            </p>
                                ...
                                {sorted.map((d,rank)=>(
                                    <div key={d.seller} className={`relative p-8 rounded-[2.5rem] border border-white/10 bg-white/5 ring-2 ${d.ring} hover:bg-white/10 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300`}>
                                        ...
                                        <div className="flex justify-between items-start mb-6 mt-2">
                                            ...
                                            {d.goalOk
                                                ? <span className="bg-amber-500/20 text-amber-500 border border-amber-500/30 px-3 py-1 rounded-full text-[10px] font-black uppercase flex items-center gap-1"><Icons.Trophy className="w-3 h-3"/> Meta atingida!</span>
                                                : <span className="bg-white/5 text-slate-500 border border-white/10 px-3 py-1 rounded-full text-[10px] font-bold">{Math.max(0,GOAL_SELLERS-d.units)} un para meta</span>
                                            }
                                        </div>
                            ...
                            <div className="p-8 rounded-[2.5rem] border border-white/10 bg-white/5">
                                <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-8">Aparelhos vs Meta ({GOAL_SELLERS} un) — Mês Atual</p>
                            ...
                            <div className="p-8 rounded-[2.5rem] border border-white/10 bg-white/5">
                                <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-8">Faturamento por Vendedora — Mês Atual</p>
